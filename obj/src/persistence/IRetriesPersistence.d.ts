...
export interface IRetriesPersistence {
    getGroupNames(correlationId: string, callback: (err: any, items: Array<string>) => void): void;
    ...
    create(correlationId: string, retry: RetryV1, callback: (err: any, retry: RetryV1) => void): void;
    update(correlationId: string, retry: RetryV1, callback: (err: any, retry: RetryV1) => void): void;
    getByIds(correlationId: string, group: string, ids: string[], callback: (err: any, retries: Array<RetryV1>) => void): void;
